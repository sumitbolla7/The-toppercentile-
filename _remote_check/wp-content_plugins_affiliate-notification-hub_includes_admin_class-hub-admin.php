...
class Hub_Admin {
    ...
    public function register_menu() {
        ...
        add_submenu_page('anh-hub', __('Referral Members', 'anh-hub'), __('Referral Members', 'anh-hub'), $cap, 'anh-referral-members', [$this, 'redirect_referral_members']);
    ...
    public function redirect_referral_members() {
        wp_safe_redirect(admin_url('admin.php?page=anh-referrals'));
        exit;
    }
    ...
    public function enqueue_assets($hook) {
        ...
        if (false !== strpos($hook, 'anh-referrals')) {
    ...
    public function handle_revoke_referral_access() {
        ...
        wp_safe_redirect(admin_url('admin.php?page=anh-referrals&revoked=1'));
        exit;
    }
